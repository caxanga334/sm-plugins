...
bool NavMeshLoad(const char[] sMapName)
{
	...
	{
		LogMessage("g_hNavMeshAreaEncounterSpots.Length: %i", g_hNavMeshAreaEncounterSpots.Length)
		LogMessage("g_hNavMeshAreaEncounterPaths.Length: %i", g_hNavMeshAreaEncounterPaths.Length)
		//for (int iIndex = 0, iSize = g_hNavMeshAreaEncounterPaths.Length; iIndex < iSize; iIndex++)
