...
void SendMessage_OnNativeVote(int client, const char[] issue, const char[] option)
{
	char servername[128];
	char contents[128];
	char buffer[512];
	...
	FormatMessage_NativeVote(issue, option, votename, sizeof(votename), voteoption, sizeof(voteoption));
