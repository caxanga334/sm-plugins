...
#define PLUGIN_NAME         "[ANY] Free duels"
#define PLUGIN_AUTHOR       "Erreur 500, caxanga334"
#define PLUGIN_DESCRIPTION	"Challenge other players to duels."
#define PLUGIN_VERSION      "3.0"
#define PLUGIN_CONTACT      "https://github.com/caxanga334/sm-plugins"
...
/**
 * caxanga334 changes:
 * No longer exclusive to TF2.
 * Removed sprites for better multi-game compatibility.
 * Modernized code.
 */
...
int g_victories[MAXPLAYERS+1]			= {0, ...};
int g_death[MAXPLAYERS+1]				= {0, ...};
int g_killsNbr[MAXPLAYERS+1]			= {0, ...};
int g_total[MAXPLAYERS+1]				= {0, ...};
float g_points[MAXPLAYERS+1]		= {0.0, ...};

bool g_Abandon[MAXPLAYERS+1]		= {false, ...};
bool g_Equality[MAXPLAYERS+1]		= {false, ...};
bool g_Winner[MAXPLAYERS+1]		= {false, ...};
bool g_SQLite 					= false;

ConVar c_EnableType[4] = {null, ...};
ConVar cvarEnabled = null;
ConVar c_EnableClass = null;
Database db;

char g_ClientSteamID[MAXPLAYERS + 1][MAX_AUTHID_LENGTH];
char g_ClientName[MAXPLAYERS + 1][MAX_NAME_LENGTH];

static const char s_DuelNames[][] = {"Disabled", "Normal", "Time left", "Amount of kills"};
static int s_TimeLeftOptions[] = {1, 2, 5, 10, 15, 20, 30, 45, 60, 120};
static int s_AmountOfKillOptions[] = {1, 2, 3, 4, 5, 10, 15, 20, 50, 75, 100, 150};
